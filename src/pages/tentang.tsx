...
function About() {
  ...
  return (
    <Layout>
      <MetaHead
        title="Tentang Kami | Hame Shorten"
        description="Hame Shorten adalah layanan pemendek tautan / URL yang gratis dan mudah untuk digunakan, buatan asli anak Indonesia"
      />
