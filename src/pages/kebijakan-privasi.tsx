...
function Privacy() {
  ...
  return (
    <Layout>
      <MetaHead
        title="Kebijakan Keamanan Privasi | Hame Shorten"
        description="Kebijakan keamanan privasi mengenai informasi pribadi Anda yang disimpan dan dibagikan di Hame Shorten"
      />
