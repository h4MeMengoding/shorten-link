...
function Terms() {
  ...
  return (
    <Layout>
      <MetaHead
        title="Ketentuan Layanan | Hame Shorten"
        description="Persyaratan layanan yang merupakan perjanjian mengikat dan mengatur penggunaan Anda atas Hame Shorten"
      />
      <VStack spacing={4} textAlign="center" as="section" mt="32">
        <VStack spacing={4} textAlign="center">
          ...
          <Image width={200} height={122} src={'/images/orange/ksana.svg'} alt="Hame Shorten" />
        </VStack>
        ...
        <Container maxW={'4xl'} mx="auto" as="section">
          <VStack spacing={8} textAlign="left">
            ...
            <Text color={textColor}>
              ...
              ditemukan di{' '}
              <Link href="/kebijakan-privasi" color="pink.400">
